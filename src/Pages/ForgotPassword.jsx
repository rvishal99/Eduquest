...
function ForgotPassword() {
    ...
    return (
        <div className="flex flex-col  items-center justify-center h-[100vh]">
            <form noValidate onSubmit={handleSubmit} className="relative flex flex-col justify-center gap-3 rounded-lg p-4 text-white w-96 shadow-[0_0_10px_black]">
            ...
            {
                show && (
                    <p className='text-white text-xl mt-5'>Password Reset Link has been sent to {email}</p>
                )
            }
