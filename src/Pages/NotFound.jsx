...
function NotFound() {
    ...
    return (
        <div className="h-screen w-full flex flex-col justify-center items-center bg-[#1A2238] tracking-widest">
            ...
            <button className="mt-5" >
                <a  className="relative inline-block text-sm font-medium text-[#FF6A3D] group active:text-yellow-500 focus:outline-none focus:ring">
                    <span onClick={()=>navigate(-1)} className='relative black px-8 py-3 bg-[#1A2238] border border-current' >
                        Go Back
                    </span>
                </a>
